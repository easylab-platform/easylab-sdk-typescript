...
// Worker sandbox payload/response types (forwarded from worker/v1). These are
// the shapes reachable through SandboxService; the request wrapper types live
// in easylab.v1 (see above).
export type {
  ExecuteResponse,
  ListJobsResponse,
  JobOutputResponse,
